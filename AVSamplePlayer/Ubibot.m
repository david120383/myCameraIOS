...
//
//#import "Ubibot.h"
//#import "UbibotIOTCAPIs.h"
//#import "UbibotAVAPIs.h"
...
////    struct st_SInfo sinfo1;
//    struct st_SInfoEx Sinfo;
//    Sinfo.size = sizeof(Sinfo);
//    ret = IOTC_Session_Check_Ex(SID, &Sinfo);
//    
//    if (ret >= 0)
//    {
//        if(Sinfo.Mode == 0)
...
//    avClientInConfig.account_or_identity    = "admin";
//    avClientInConfig.password_or_token      = "ipc12345";
...
//    if (avIndex < 0) {
//        printf("avClientStartEx failed avIndex[%d]\n", avIndex);
//        return NULL;
//    }
//    printf("avClientStartEx success avIndex[%d] resend[%d] two_way_streaming[%d]\n",
